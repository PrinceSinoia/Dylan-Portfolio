...
const Project = ({ project }) => {
  ...
  return (
    <div className="project">
      ...
      <img  data-aos="zoom-in"className={`project-image project-image-${project.id}`} src={imageUrl} alt={title} />
      <div      data-aos="fade-right"  className='text'>
      <h3 className={`project-title project-title-${project.id}`}>{title}</h3>
      {/* <p className={`project-description project-description-${project.id}`}>{description}{icon}</p> */}
      {/* <p className={`project-description project-description-${project.id}`}>
            {description}
            <span className={`project-icon project-icon-${project.id}`}>
          <div className='svg-div'>  <IoIosArrowRoundForward /></div>
             </span>
          </p> */}
...
const projects = [
  {
    ...
    imageUrl: './dylan-home-images/portfolio-work-image.png',
  ...
  },
  {
    ...
    imageUrl: './dylan-home-images/can-image-1.png',
  },
  {
    id: 3,
    title: 'Branding Design',
    description: 'MI5 Group - Visual Language Of The Brand',
    imageUrl: './dylan-home-images/mi5-image.png',
  },
