...
const CustomMobileLink = ({
  ...
  if (isHovered && title === "Discover Tay") {
    hoveredImage = (
      <span className="w-1/7 p-2 py-1 ml-5 cursor-pointer overflow-hidden border border-light rounded-full lg:w-1/7">
        <img
          src="./dylan-home-images/prince.png"
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <motion.h1
          className={` text-9xl flex justify-center -left-40 items-center mt-32 w-screen absolute rounded-lg ${className} `}
  ...
  return (
    ...
    >
      <button
        ...
        onClick={handleClick}
      >
        <span className="sr-only text-orange-600 text-5xl">Open main menu</span>
        <span
      ...
      {isOpen ? (
        <motion.div
          ...
          className="min-w-[80vw] sm:min-w-[100vw] h-[100vh] xl:h-[50vh] md:h-[100vh] z-1 flex justify-between items-center flex-col absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 py-32 pb-40 bg-orange-950 !text-light   backdrop-blur-md "
        >
          <nav className="grid self-start pl-32 xs:pl-10">
            <CustomMobileLink
              ...
              title2="About Tay"
              buttonC="Download CV"
              img1="./dylan-home-images/prince.png"
            ...
            <CustomMobileLink
              ...
              title2="Portfolio"
              buttonC="Projects"
              img2="./dylan-home-images/prince.png"
              className=" !text-light "
              toggle={handleClick}
            />
            <CustomMobileLink
              ...
              title="Contact Tay"
              title2="Get In Touch"
              img3="./dylan-home-images/prince.png"
              call="+263 771 733 755"
              img4="./dylan-home-images/prince.png"
